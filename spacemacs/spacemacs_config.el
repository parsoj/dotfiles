...
before packages are loaded."
  ...
  ;; use icons in neotree - TODO spacemacs neotree layer is broken right now - check in later for fix
  ;;(neo-theme 'icons)
