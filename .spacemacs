...
you should place your code here."
  ...
  (setq mouse-wheel-progressive-speed nil) ;; don't accelerate scrolling  ;;set 
  ...
  ;;use bash as default ansi-term shell
