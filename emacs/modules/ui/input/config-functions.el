...
(with-eval-after-load '+hydra
  ...
  (defun do-config-file-jump (message file-list)
    (interactive)
  ...
  (pretty-hydra-define hydra-config-actions
    ...
    (
     ...
     (("M" create-new-module "new module")
      ("m" (lambda() (interactive) (do-config-file-jump "Jump To Module: " (get-all-config-files)) ) "module")
     ...
     (("l" (lambda() (interactive) (find-file "~/.emacs.d/straight/versions/default.el") ) "packages lockfile")
      ("p" (lambda() (interactive) (do-config-file-jump "Jump To Package: " (get-all-package-files)) ) "package code")
      )
