;;; parsoj-tools/numbers/config.el -*- lexical-binding: t; -*-

(defun numbers-increment-decimal-number-at-point (&optional arg)
...
(defun numbers-decrement-decimal-number-at-point (&optional arg)
  (interactive "p*")
  (my-increment-number-decimal (if arg (- arg) -1)))

(defun numbers-increment-hexadecimal-number-at-point (&optional arg)
  "Increment the number forward from point by 'arg'."
  (interactive "p*")
  (save-excursion
    (save-match-data
...
(defun numbers-format-bin (val width)
...
(defun numbers-increment-binary-number-at-point (&optional arg)
  "Increment the number forward from point by 'arg'."
  (interactive "p*")
  (save-excursion
    (save-match-data
